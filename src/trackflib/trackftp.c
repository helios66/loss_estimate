...
int isFTP(mapidflib_function_instance_t *, unsigned char *, int );
...
static int trackftp_init(mapidflib_function_instance_t *instance, MAPI_UNUSED int fd)
{
	int i=0;
