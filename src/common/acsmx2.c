...
*/ 
int acsmAddKey2(ACSM_STRUCT2 * p, unsigned char *key, int klen, int nocase)
{
  ACSM_PATTERN2 * plist;
...
*/
inline 
acstate_t SparseGetNextStateNFA(acstate_t * ps, acstate_t state, int  input)
{
   acstate_t fmt;
   acstate_t n;
   int       index;
...
*/
inline 
acstate_t SparseGetNextStateDFA(acstate_t * ps, MAPI_UNUSED acstate_t state, int  input)
{
   acstate_t  n, nb;
   int        index;
