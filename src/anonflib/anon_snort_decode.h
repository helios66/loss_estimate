...
/* $Id: anon_snort_decode.h,v 1.1 2005/02/07 20:53:18 antonat Exp $ */
...
#ifndef IP6_MAXPACKET
#define IP6_MAXPACKET   65535           /* maximum packet size */
#endif /* IP6_MAXPACKET */
...
typedef struct ip6_hdr IPV6Hdr;
#define IP6_VER(ip6h)      (((ip6h)->ip6_vfc & 0xf0) >> 4)
