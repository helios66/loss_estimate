...
void PrintEthHeader(FILE * fp, mapipacket * p);
void PrintIPPkt(FILE * fp, int type, mapipacket * p);
void PrintTcpOptions(FILE * fp, mapipacket * p);
void PrintIpOptions(FILE * fp, mapipacket * p);
void PrintTCPHeader(FILE * fp, mapipacket * p);
void PrintIPHeader(FILE * fp, mapipacket * p);
void PrintEmbeddedTCPHeader(FILE * fp, mapipacket * p, int size);
void CreateTCPFlagString(mapipacket * p, char *flagBuffer);
void PrintNetData(FILE * fp, u_char * start, const int len);
void PrintICMPHeader(FILE * fp, mapipacket * p);
void PrintUDPHeader(FILE * fp, mapipacket * p);
void ts_print(register const struct timeval *tvp, char *timebuf);
void Print2ndHeader(FILE * fp, mapipacket * p,int datalink);
void PrintPacket(FILE *fp, mapipacket *p,int datalink); 
void InitProtoNames();
void PrintArpHeader(FILE * fp, mapipacket * p);
void PrintTrHeader(FILE * fp, mapipacket * p);
void PrintWifiPkt(FILE * fp, mapipacket * p,int datalink);
void PrintWifiHeader(FILE * fp, mapipacket * p);
void PrintSLLHeader(FILE * fp, mapipacket * p);
void PrintEapolHeader(FILE * fp, mapipacket * p);
void PrintEAPHeader(FILE * fp, mapipacket * p);
void PrintEapolKey(FILE * fp, mapipacket * p);
void PrintEapolPkt(FILE * fp, mapipacket * p,int datalink);
...
void PrintIPPkt(FILE * fp, MAPI_UNUSED int type, mapipacket * p)
{
...
void PrintPacket(MAPI_UNUSED FILE *fp, mapipacket *p,int datalink) {
		if(p->iph != NULL)
